 ...
 *
 * A single, tree-shakable-ish source for the small icon set used across the
 * site. Every icon shares the same 24×24 grid, 1.6 stroke width, round caps
 * and `currentColor`, so stroke weight stays consistent. Icons are purely
 * decorative (`aria-hidden`); meaning always comes from neighbouring text or
...
export class AppIcon {
  readonly name = input<AppIconName>('arrow-right');
